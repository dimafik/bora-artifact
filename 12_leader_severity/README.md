...
**Correction (2026-09-16).** The throughput rows below are Caliper's rate
...
**25 runs whose own clean arm verified at ≥ 450 tx/s** (see *Caveat* below; Caliper rate figure):
