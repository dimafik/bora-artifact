---- MODULE Enabledness_TTrace_1786593587 ----
...
_inv ==
    ~(
        ...
        /\
        leader = ((0 :> 0 @@ 1 :> 1 @@ 2 :> 0 @@ 3 :> 0))
        /\
        votedFor = (<<1, 2, 0, 0, 0>>)
        /\
        currentTerm = (<<1, 1, 0, 0, 0>>)
        /\
        log = (<<<<>>, <<>>, <<>>, <<>>, <<>>>>)
        /\
        state = (<<"leader", "candidate", "follower", "follower", "follower">>)
        /\
        history = (<<>>)
        /\
...
\* to `JsonSerialize`. For example, a sub-sequence of _TETrace.
    \* ASSUME
    \*     LET J == INSTANCE Json
    \*         IN J!JsonSerialize("Enabledness_TTrace_1786593587.json", _TETrace)
...
\*
\*trace == IODeserialize("Enabledness_TTrace_1786593587.bin", TRUE)
\*
\*=============================================================================
\*
...
trace == 
    ...
    ([leader |-> (0 :> 0 @@ 1 :> 1 @@ 2 :> 0 @@ 3 :> 0),votedFor |-> <<1, 2, 0, 0, 0>>,currentTerm |-> <<1, 1, 0, 0, 0>>,log |-> <<<<>>, <<>>, <<>>, <<>>, <<>>>>,state |-> <<"leader", "candidate", "follower", "follower", "follower">>,history |-> <<>>,commitIndex |-> <<0, 0, 0, 0, 0>>])
    >>
----
...
---- CONFIG Enabledness_TTrace_1786593587 ----
CONSTANTS
    N = 5
    F = 2
    MaxTerm = 3
...
ALIAS
    _expression
=============================================================================
\* Generated on Thu Aug 13 12:59:47 KST 2026