---- MODULE Enabledness_TTrace_1786593588 ----
...
\* to `JsonSerialize`. For example, a sub-sequence of _TETrace.
    \* ASSUME
    \*     LET J == INSTANCE Json
    \*         IN J!JsonSerialize("Enabledness_TTrace_1786593588.json", _TETrace)
...
\*
\*trace == IODeserialize("Enabledness_TTrace_1786593588.bin", TRUE)
\*
\*=============================================================================
\*
...
---- CONFIG Enabledness_TTrace_1786593588 ----
CONSTANTS
    N = 5
    F = 2
    MaxTerm = 3
...
ALIAS
    _expression
=============================================================================
\* Generated on Thu Aug 13 12:59:48 KST 2026