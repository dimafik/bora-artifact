---- MODULE Enabledness_TTrace_1786593585 ----
...
\* to `JsonSerialize`. For example, a sub-sequence of _TETrace.
    \* ASSUME
    \*     LET J == INSTANCE Json
    \*         IN J!JsonSerialize("Enabledness_TTrace_1786593585.json", _TETrace)
...
\*
\*trace == IODeserialize("Enabledness_TTrace_1786593585.bin", TRUE)
\*
\*=============================================================================
\*
...
---- CONFIG Enabledness_TTrace_1786593585 ----
CONSTANTS
    N = 5
    F = 2
    MaxTerm = 3
...
ALIAS
    _expression
=============================================================================
\* Generated on Thu Aug 13 12:59:46 KST 2026