...
(* that does: if a quorum of voters holds candidate i and their guards do   *)
(* not fail open, i cannot acquire leadership.                              *)
(*                                                                         *)
...
(* agreement and no fail-open, exclusion follows from the vote-grant guard  *)
(* alone. That conditional is what is proved here, and it is exactly what   *)
