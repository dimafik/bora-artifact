---- MODULE BORA_pv_MC_TTrace_1789953290 ----
...
\* to `JsonSerialize`. For example, a sub-sequence of _TETrace.
    \* ASSUME
    \*     LET J == INSTANCE Json
    \*         IN J!JsonSerialize("BORA_pv_MC_TTrace_1789953290.json", _TETrace)
...
\*
\*trace == IODeserialize("BORA_pv_MC_TTrace_1789953290.bin", TRUE)
\*
\*=============================================================================
\*
...
trace == 
    ...
    ([failOpen |-> FALSE,leader |-> (0 :> 0 @@ 1 :> 0),votedFor |-> <<0, 0, 0>>,blSeq |-> 1,currentTerm |-> <<0, 0, 0>>,log |-> <<<<>>, <<>>, <<>>>>,blacklist |-> <<{}, {}, {1}>>,state |-> <<"follower", "follower", "follower">>,history |-> <<>>,commitIndex |-> <<0, 0, 0>>]),
    ([failOpen |-> FALSE,leader |-> (0 :> 0 @@ 1 :> 0),votedFor |-> <<1, 0, 0>>,blSeq |-> 1,currentTerm |-> <<1, 0, 0>>,log |-> <<<<>>, <<>>, <<>>>>,blacklist |-> <<{}, {}, {1}>>,state |-> <<"candidate", "follower", "follower">>,history |-> <<>>,commitIndex |-> <<0, 0, 0>>]),
    ([failOpen |-> FALSE,leader |-> (0 :> 0 @@ 1 :> 0),votedFor |-> <<1, 0, 0>>,blSeq |-> 2,currentTerm |-> <<1, 0, 0>>,log |-> <<<<>>, <<>>, <<>>>>,blacklist |-> <<{1}, {}, {1}>>,state |-> <<"candidate", "follower", "follower">>,history |-> <<>>,commitIndex |-> <<0, 0, 0>>]),
    ([failOpen |-> FALSE,leader |-> (0 :> 0 @@ 1 :> 1),votedFor |-> <<1, 0, 0>>,blSeq |-> 2,currentTerm |-> <<1, 0, 0>>,log |-> <<<<>>, <<>>, <<>>>>,blacklist |-> <<{1}, {}, {1}>>,state |-> <<"leader", "follower", "follower">>,history |-> <<>>,commitIndex |-> <<0, 0, 0>>])
    >>
----
...
---- CONFIG BORA_pv_MC_TTrace_1789953290 ----
CONSTANTS
    N = 3
    F = 2
    MaxTerm = 1
...
ALIAS
    _expression
=============================================================================
\* Generated on Mon Sep 21 10:14:51 KST 2026