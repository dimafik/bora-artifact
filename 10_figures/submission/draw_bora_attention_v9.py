...
fig.savefig("bora_attention_arch_v9.png", dpi=240, bbox_inches="tight", facecolor="white")
fig.savefig("bora_attention_arch_v9.pdf", bbox_inches="tight", facecolor="white")
print(f"wrote bora_attention_arch_v9.png / .pdf   [{SRC}]")
